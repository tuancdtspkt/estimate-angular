...
namespace WindowsFormsApplication1
{
    ...
    {
        protected int    obsMethod=1;

        protected double dt = 3.0f / 1000.0f;                                   // sampling period
        protected double gyroOffRoll = 0;//-3.6982;
        protected double gyroOffPitch = 0;// -3.3570;
        protected double gyroOffYaw = 0;//-2.5909;

        protected double magnOffX=0;//0.40;
        protected double magnOffY=0;//0.07;
        protected double magnOffZ=0;//-0.11;
        protected double magnSFX=1;//1.1;
        protected double magnSFY=1;//1;
